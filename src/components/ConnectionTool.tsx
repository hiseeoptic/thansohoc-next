...
<h4>🤝 GIAO TIẾP & THUYẾT PHỤC (Theo Thần Số Học – Bộ chỉ số đang phân tích)</h4>

<p><strong>Phân tích dành riêng cho bộ chỉ số: 
<strong>[Life Path ${lifePath} + Heart Desire ${heartDesire} + Mission ${mission} + Personality ${personality} + ...]</strong></strong><br>
AI phải bám sát đặc điểm cốt lõi của từng con số trong bộ chỉ số trên (đã được trích xuất từ Google Sheet) để đưa ra cách giao tiếp, thuyết phục và bán hàng phù hợp nhất.</p>

<ul>
    <li>
        <strong>Cách Tiếp Cận Tối Ưu (Do's):</strong>
        <ul>
            <li><strong>Phong cách mở đầu phù hợp:</strong> 
                Dựa trên động lực lõi của bộ số này (Hành động / Cảm xúc / Sáng tạo / Trí tuệ), nên bắt đầu bằng… 
                (AI sẽ điền cụ thể theo từng số).
            </li>
            <li><strong>Cách truyền đạt thông tin:</strong> 
                Sử dụng ngôn ngữ [trực tiếp & kết quả rõ ràng] / [cảm xúc & câu chuyện] / [ý tưởng sáng tạo] / [logic & phân tích sâu] – tùy theo nhóm động lực chủ đạo của bộ số.
            </li>
            <li><strong>Cách đưa giải pháp:</strong> 
                Trình bày theo cách bộ số này dễ chấp nhận nhất (kết quả đo lường được / sự an toàn cảm xúc / cơ hội thể hiện sáng tạo / chiều sâu chiến lược).
            </li>
            <li><strong>Ví dụ thực tế:</strong> 
                Minh họa 1 tình huống tư vấn / bán hàng / đàm phán thành công với người mang đúng bộ chỉ số này.
            </li>
        </ul>
    </li>

    <li>
        <strong>Điều Tuyệt Đối Không Nên Làm (Don'ts):</strong>
        <ul>
            <li><strong>Điểm kích hoạt tiêu cực:</strong> 
                Những hành vi dễ khiến người này phòng thủ, mất lòng tin hoặc rút lui (dựa trên nỗi sợ cốt lõi của từng số trong bộ).
            </li>
            <li><strong>Sai phong cách giao tiếp:</strong> 
                Ví dụ: nói vòng vo với người cần rõ ràng, quá khô khan với người thiên cảm xúc, hoặc ép quyết định nhanh với người cần phân tích sâu.
            </li>
            <li><strong>Hậu quả nếu chạm sai:</strong> 
                Họ có thể im lặng, chống đối, mất niềm tin lâu dài, hoặc rút lui hoàn toàn.
            </li>
        </ul>
    </li>

    <li>
        <strong>Điểm Mù Tâm Lý & Đòn Bẩy Thuyết Phục:</strong>
        <ul>
            <li><strong>Nỗi sợ cốt lõi của bộ số này:</strong> 
                (AI sẽ trích xuất từ context: mất kiểm soát, bị từ chối, thiếu giá trị, không đạt mục tiêu…)
            </li>
            <li><strong>Cách khai thác tích cực:</strong> 
                Biến nỗi sợ thành động lực bằng cách đưa ra giải pháp giúp họ cảm thấy [an toàn / mạnh mẽ / được công nhận / có tầm nhìn].
            </li>
            <li><strong>Đòn bẩy thuyết phục mạnh nhất:</strong> 
                Quyền lựa chọn / Sự công nhận / Sự đảm bảo / Tầm nhìn dài hạn / Kết quả nhanh chóng (chọn 1–2 yếu tố phù hợp nhất với bộ số).
            </li>
            <li>🔥 <strong>Insight then chốt:</strong> Không bán sản phẩm/dịch vụ → Hãy bán đúng “điểm chạm tâm lý” của bộ số này.</li>
        </ul>
    </li>

    <li>
        <strong>💰 Ứng Dụng Thực Tế Trong Tư Vấn – Bán Hàng – Chốt Deal</strong>
        <ul>
            <li><strong>Trọng tâm cần đánh vào:</strong> Yếu tố khiến họ sẵn sàng quyết định (kết quả rõ ràng / cảm xúc / sự an toàn / giá trị bản thân / tầm nhìn).</li>
            <li><strong>Cách xây dựng niềm tin:</strong> Chứng minh bằng [kết quả thực tế / câu chuyện / dữ liệu / trải nghiệm cá nhân] phù hợp với nhóm động lực của họ.</li>
            <li><strong>Cách trình bày sản phẩm/dịch vụ:</strong> Điều chỉnh tốc độ và phong cách theo cách họ ra quyết định.</li>
            <li><strong>Cách xử lý từ chối:</strong> Hiểu lý do thật sự (thường xuất phát từ nỗi sợ cốt lõi) và xử lý đúng điểm đó.</li>
            <li><strong>Cách chốt (Closing):</strong> Đưa đề nghị sao cho họ cảm thấy đang kiểm soát hoặc đang mở ra cơ hội lớn hơn.</li>
        </ul>
    </li>

    <li>
        <strong>❤️ Xây Dựng Mối Quan Hệ Lâu Dài (Tình Cảm / Đối Tác)</strong>
        <ul>
            <li><strong>Nên làm:</strong> Những hành động giúp họ cảm thấy được hiểu và trân trọng theo đúng ngôn ngữ tình cảm của bộ số.</li>
            <li><strong>Không nên làm:</strong> Những hành vi dễ gây tổn thương sâu (dựa trên điểm yếu của từng số).</li>
            <li><strong>Dấu hiệu rạn nứt sớm:</strong> Cách nhận biết khi họ bắt đầu phòng thủ hoặc rút lui.</li>
        </ul>
    </li>
</ul>

<p><em><strong>Lưu ý cho AI:</strong> Toàn bộ phân tích phải dựa hoàn toàn vào đặc điểm của các con số đang được tra cứu (Life Path, Heart Desire, Mission, Personality, Maturity…). Không được dùng nội dung chung chung. Phải trích dẫn rõ ràng đặc điểm từ context dữ liệu gốc và đưa ra ví dụ thực tế cụ thể.</em></p>
